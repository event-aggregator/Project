"""
Django settings for EventAggregator project.
...
SECRET_KEY = 'c0^lwut2jnwlq#6grgc=bb&6xqqybtpb&%_%+8x^lb(7^(=7$x'
...
ROOT_URLCONF = 'EventAggregator.urls'
...
WSGI_APPLICATION = 'EventAggregator.wsgi.application'
